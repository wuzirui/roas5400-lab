"""RoPE1D test with deterministic input and expected output snapshot."""
...
from .adapters import run_rope1d


ASSETS_DIR = Path(__file__).resolve().parent / "assets"
EXPECTED_PATH = ASSETS_DIR / "rope1d_expected.npz"


def test_rope1d_matches_expected():
